...
function Addresses() {
  ...
  async function addAddress() {
    ...
    try {
      const data = (await axios.post('https://res.creativeparkingsolutions.com/api/user/addaddress', info)).data
  ...
  async function primary(ID) {
    ...
    try {
      const data = (await axios.post('https://res.creativeparkingsolutions.com/api/user/setaddressprimary', info)).data
      update()
    ...
    if(getstatus==="true")
  {
   const user =JSON.parse(localStorage.getItem('currentuser'))[0].customer_Id;
      ...
      try {
        ...
        const data = ( await axios.post("https://res.creativeparkingsolutions.com/api/user/getaddress",temp)).data;
        console.log(data.data)
  ...
  async function updateAddress(){
    ...
    try {
      const data = await (await axios.post('https://res.creativeparkingsolutions.com/api/user/getaddress', user)).data
      setAddress(data.data)
  ...
  async function del(ID) {
    ...
    try {
      const data = (await axios.post('https://res.creativeparkingsolutions.com/api/user/deleteaddress', info)).data
      update()
        ...
        <div className="row flex-nowrap">
          ...
          <div className="col-md-9"> */}
            <div className="row justify-content-center">
              <div className="col-md-10 bs br mx-4 my-5 py-4 px-4 reducedwidth responsiveness">
                <div className="container userprofileinfo">
                <h1 className="responsiveness usertitle">MY ADDRESSES</h1>
                  <button
                    type="button"
                    className="btn usercartbtn"
              ...
              <div className="modal-dialog">
                <div className="modal-content">
                  ...
                  <div className="modal-footer">
                    ...
                    <button type="button" onClick={addAddress} className="btn btn-outline-dark">
                      Save
                    </button>
                  </div>
                </div>
